/**
 * 描述: h5音乐播放器
 * 参考  http://www.haorooms.com/
 * http://resource.haorooms.com/softshow-7-117-1.html
 * 修改之处: 定制了部分样式,以及增加了上一首,下一首按钮 功能
 */
function APlayer(e) {
...
APlayer.prototype.init = function() {
	...
	if(this.element.innerHTML = '<div class="aplayer-container"><div class="ciecle1 pre"><div class="pre1"></div><div class="pre2"></div></div><div class="circle2 aplayer-play"><div class="play "></div></div><div class="circle2 aplayer-pause aplayer-hide"><div class=" pause"><div class="pause1"></div><div class="pause2"></div></div></div><div class="ciecle1 next"><div class="next1"></div><div class="next2"></div></div></div><div class="aplayer-pic"><img src="' + this.music.pic + '"><div class="aplayer-button aplayer-pause aplayer-hide"><i class="demo-icon aplayer-icon-pause"></i></div><div class="aplayer-button aplayer-play"><i class="demo-icon aplayer-icon-play"></i></div></div><div class="aplayer-info"><div class="aplayer-music"><span class="aplayer-title">' + this.music.title + '</span><span class="aplayer-author"> - (＞﹏＜)加载中,好累的说...</span></div><div class="aplayer-lrc"><div class="aplayer-lrc-contents" style="transform: translateY(0);"></div></div><div class="aplayer-controller"><div class="aplayer-bar-wrap"><div class="aplayer-bar"><div class="aplayer-loaded" style="width: 0"></div><div class="aplayer-played" style="width: 0"><span class="aplayer-thumb"></span></div></div></div><div class="aplayer-time"><span class="aplayer-ptime">00:00</span> / <span class="aplayer-dtime">(oﾟ▽ﾟ)</span><div class="aplayer-volume-wrap"><i class="demo-icon aplayer-icon-volume-down"></i><div class="aplayer-volume-bar-wrap"><div class="aplayer-volume-bar"><div class="aplayer-volume" style="height: 80%"></div></div></div></div></div></div></div>', this.option.showlrc) {
	...
	}), this.playButton = this.element.getElementsByClassName("aplayer-play")[0], this.pauseButton = this.element.getElementsByClassName("aplayer-pause")[0], this.forwardButton = this.element.getElementsByClassName("next")[0], this.backwardButton = this.element.getElementsByClassName("pre")[0], this.playButton.addEventListener("click", function() {
		self.option.play && self.option.play();
		m.play.call(m)
	}), this.forwardButton.addEventListener("click", function() {
		self.option.next && self.option.next();
	}), this.backwardButton.addEventListener("click", function() {
		self.option.pre && self.option.pre();
	}), this.pauseButton.addEventListener("click", function() {
		self.option.pause && self.option.pause();
		m.pause.call(m)
	...
	}), this.option.autoplay && this.play(), this.option.play && this.option.play();
